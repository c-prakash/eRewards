using Autofac;
using ezloyalty.Services.Programs.API.Application.IntegrationEvents;
    ...
    public static class IServiceCollectionExtensions
    {
        ...
        public static IServiceCollection AddSwagger(this IServiceCollection services)
        {
            services.AddSwaggerGen(options =>
            {
                ...
                {
                    Title = "ezloyalty - Programs HTTP API",
                    Version = "v1",
                    Description = "The Programs Microservice HTTP API."
                });
        ...
        public static IServiceCollection AddIntegrationServices(this IServiceCollection services, IConfiguration configuration)
        {
            ...
            services.AddTransient<IProgramIntegrationEventService, ProgramIntegrationEventService>();

            if (configuration.GetValue<bool>("AzureServiceBusEnabled"))
            {
                services.AddSingleton<IServiceBusPersisterConnection>(sp =>
                {
                    var settings = sp.GetRequiredService<IOptions<Programsettings>>().Value;
        ...
        public static IServiceCollection AddHealthChecks(this IServiceCollection services, IConfiguration configuration)
        {
            ...
            hcBuilder
                ...
                name: "ProgramsDB-check",
                tags: new string[] { "programsdb" });
            ...
            if (configuration.GetValue<bool>("AzureServiceBusEnabled"))
            {
                hcBuilder
                    ...
                    name: "programs-servicebus-check",
