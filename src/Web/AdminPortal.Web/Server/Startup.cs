...
using AdminPortal.Web.Infrastructure.Extensions;
using AdminPortal.Web.Server.Extensions;
using AdminPortal.Web.Server.Middlewares;
...
namespace AdminPortal.Web.Server
{
