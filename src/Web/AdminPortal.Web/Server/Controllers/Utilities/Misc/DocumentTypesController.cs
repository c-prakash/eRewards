...
using AdminPortal.Web.Application.Features.DocumentTypes.Commands.Delete;
using AdminPortal.Web.Application.Features.DocumentTypes.Queries.Export;
...
namespace AdminPortal.Web.Server.Controllers.Utilities.Misc
{
