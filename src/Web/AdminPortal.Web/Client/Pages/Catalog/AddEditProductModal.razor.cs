...
using AdminPortal.Web.Client.Infrastructure.Managers.Catalog.Brand;
using AdminPortal.Web.Client.Infrastructure.Managers.Catalog.Product;
using AdminPortal.Web.Application.Enums;

namespace AdminPortal.Web.Client.Pages.Catalog
{
    public partial class AddEditProductModal
    {
        ...
        private async Task UploadFiles(InputFileChangeEventArgs e)
        {
            ...
            if (_file != null)
            {
                ...
                AddEditProductModel.UploadRequest = new UploadRequest { Data = buffer, UploadType = UploadType.Product, Extension = extension };
            }
        }
