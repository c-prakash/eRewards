...
using AdminPortal.Web.Client.Infrastructure.Authentication;
using AdminPortal.Web.Client.Infrastructure.Managers;
using AdminPortal.Web.Client.Infrastructure.Managers.Preferences;
...
using AdminPortal.Web.Client.Infrastructure.Managers.ExtendedAttribute;
...
namespace AdminPortal.Web.Client.Extensions
{
    public static class WebAssemblyHostBuilderExtensions
    {
        private const string ClientName = "eRewards.API";
        ...
        public static IServiceCollection AddServices(this IServiceCollection services)
        {
            ...
            RegisterTypedClient<IMemberAdminManager, MemberAdminManager>(new Uri(Infrastructure.Routes.MemberAdminEndpoints.RootEndpoint));
