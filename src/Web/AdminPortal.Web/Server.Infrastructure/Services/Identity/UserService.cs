...
using AutoMapper;
using AdminPortal.Web.Application.Exceptions;
...
using AdminPortal.Web.Infrastructure.Specifications;
using AdminPortal.Web.Shared.Constants.Role;
...
namespace AdminPortal.Web.Infrastructure.Services.Identity
{
